...
// const api = `${BASE_URL}${initialState.City}${UNIT_QUERY}${initialState.Unit}${KEY}`;
...
export const fetchData = () => {
	return (dispatch) => {
		...
		axios
			.get(
				'https://api.openweathermap.org/data/2.5/forecast?q=oxford,ct,us&appid=8b2bbcd3ad925dcc913ae8a19159124a&units=imperial'
			)
			.then((response) => {
				//start of data
